...
describe('endpoints', () => {
  ...
  it.each([
    ...
    [() => api.buildings.remove(3), 'DELETE', '/buildings/3', undefined],
    [() => api.incidents.list({ scope: 'all', status: 'open,blocked', category: 'plumbing', page: 2 }), 'GET', '/incidents?scope=all&status=open%2Cblocked&category=plumbing&page=2', undefined],
    ...
    [() => api.incidents.updateCategory(12, 'hvac'), 'PUT', '/incidents/12/category', { category: 'hvac' }],
    ...
    [() => api.stats.engineers(14), 'GET', '/incidents/stats/engineers?days=14', undefined],
